            ...
            <section id="events" className="section">
                ...
                <div className="events-grid">
                    <a href="/events?filter=tech" className="event-card-link">
                        <div className="event-card">
                            <div className="event-image">
                                <img decoding="async" loading="lazy" src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80" alt="Tech Event Image" />
                            </div>
                    ...
                    <a href="/events?filter=non-tech" className="event-card-link">
                        <div className="event-card">
                            <div className="event-image">
                                <img decoding="async" loading="lazy" src="https://images.unsplash.com/photo-1541532713592-79a0317b6b77?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80" alt="Non-Tech Event Image" />
                            </div>
                            <div className="event-content">
